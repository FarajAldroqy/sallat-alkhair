    ...
    >
      ...
      >
        ...
        <div className="absolute inset-2 rounded-full overflow-hidden flex items-center justify-center">
          {/* خلفية سائلة غنية بالتوهج */}
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-300/40 via-teal-500/20 to-emerald-950/80 animate-pulse duration-1000" />

          {/* دوائر طاقة برّاقة تدور داخل الحوض */}
          <motion.div
            animate={{ rotate: 360 }}
            transition={{ duration: 18, repeat: Infinity, ease: "linear" }}
            className="absolute -inset-10 border border-emerald-200/30 rounded-full border-dashed pointer-events-none"
          />
          <motion.div
            animate={{ rotate: -360 }}
            transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
            className="absolute inset-4 border border-emerald-300/20 rounded-full pointer-events-none"
          />
        ...
        >
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-950/60 text-emerald-300 border border-emerald-400/40 text-[11px] font-bold mb-2 shadow-inner">
            <Coins className="w-3.5 h-3.5 text-emerald-400 animate-spin" style={{ animationDuration: "6s" }} />
